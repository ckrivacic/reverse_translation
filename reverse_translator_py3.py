...
Usage:
    reverse_translator.py [options] <input_fasta_or_folder> <output_file>
    ...
    with open(inputs) as f:
        ...
        for line in f:
            if line[0] == '>':
                ...
                protein_sequences[current_sequence] = ''
            else:
...
if from_files:
    protein_sequences = import_protein_structure(inputs,arguments['--combine-chains'])
